...
import { onlyAlphaNumericKey } from './1_onlyAlphaNumericKey'
...
describe('0_utils', () => {
	...
	describe('1_onlyAlphaNumericKey', () => {
		it('test with < {"sd U&Y-P":1,"sjs 2&%^ksaui2":2}  >', () => {
			expect.assertions(1)
			expect(
				onlyAlphaNumericKey({ 'sd U&Y-P': '1', 'sjs 2&B%^kS_a?ui2': '2' })
			).toEqual({ sjs2bksaui2: '2', sduyp: '1' })
		})
	})
