...
const removerSpecialChar = name =>
	name.replace(/[^a-zA-Z0-9 ]/g, '').toLowerCase()

const symbol_ = name => symbols[namesLower.indexOf(removerSpecialChar(name))]
...
const symbolM_ = name =>
	symbol[name] || (symbol[name] = symbol[removerSpecialChar(name)])
